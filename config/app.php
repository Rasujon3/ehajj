...
|--------------------------------------------------------------------------
*/
    'PASSPORT_VERIFY_URL' => env('PASSPORT_VERIFY_URL'),
    /*
      |--------------------------------------------------------------------------
      | REDIS Configuration
      |--------------------------------------------------------------------------
    ...
    |--------------------------------------------------------------------------
    */
    'SERVER_PUBLIC_DIR_PATH' => env('SERVER_PUBLIC_DIR_PATH'),

    'web_service_url' => env('web_service_url'),
    'web_service_url_reg_key' => env('web_service_url_reg_key'),
    'api_access_key' => env('API_ACCESS_KEY'),

    'mongo_audit_log' => env('mongo_audit_log'),
    ...
    */
    ...
    'SOCIAL_WIDGET_KEY' => env('SOCIAL_WIDGET_KEY'),
    'PDF_API_BASE_URL' => env('PDF_API_BASE_URL'),
