    ...
    <div class="col-sm-4">
        ...
        {!! $errors->first('selection_type','<span class="help-block">:message</span>') !!}
            ...
            <fieldset style=""; id="permission_data">
                <?php $type2=($selection_type==1 || $selection_type==null ?'display:none;':'');?>
                <?php $type1=($selection_type==2 || $selection_type==null ?'display:none;':'');?>
                ...
                <fieldset class="scheduler-border" style="padding: 0px; {{$type1}}" id="user_specific_data" >
                    ...
                    <div class="form-group {{$errors->has('user_type') ? 'has-error' : ''}}">
                        ...
                        {!! Form::select('user_type[]', $usersList,$selected_user_type,['class' => 'form-control  required user_id','multiple','id'=>'user_types', 'size' => 10]) !!}
