            ...
            <!-- /.panel-heading -->
                <div class="card-body">
                    ...
                    <div class="form-group col-md-12 row {{$errors->has('service_name') ? 'has-error' : ''}}" id="service_name">
                        ...
                        <div class="col-md-6">
                            {!! Form::text('service_name', $app->group_nm_bn,  ['class' => 'form-control bnEng', 'readonly' => 'true']) !!}
                    ...
                    <div class="form-group col-md-12 row {{$errors->has('title_details') ? 'has-error' : ''}}">
                        ...
                        <div class="col-md-6">
                            {!! Form::text('title_details', $app->details, ['class' => 'form-control required bnEng']) !!}
                    ...
                    <div class="form-group col-md-12 row">
                        ...
                        <div class="col-md-6">
                            <img src="{{ '/'.$app->logo }}" alt="" width="50px">
                            <input type="file" class="form-control" name="logo" id="logo" ref="logo"/>
                    ...
                    <div class="form-group col-md-12 row {{$errors->has('service_details') ? 'has-error' : ''}}">
                        ...
                        <div class="col-md-10">
                            <table id="serviceDetailsTable"
                                ...
                                <tr id="serviceDetailsTableRow{{$inc}}" data-number="1">
                                    <td>
                                        {!! Form::hidden("details_id[$inc]", $detail->id) !!}
                                        {!! Form::text("service_heading[$inc]", $detail->service_heading, ['class' => 'form-control input-md bnEng required', 'placeholder' => trans('messages.available_sevices.heading')]) !!}
                                    </td>
                                    <td>
                                        {!! Form::textarea("service_details[$inc]", $detail->details, ['class' => 'form-control input-md service_details bnEng required']) !!}
                                    </td>
                                    <td>
                                        <?php if ($inc == 0) { ?>
                                        <a class="btn btn-sm btn-primary addTableRows" title="Add more"
                                           onclick="addTableRow('serviceDetailsTable', 'serviceDetailsTableRow0');"><i
                                                    class="fa fa-plus"></i></a>
                                            <?php } else { ?>
                                            <a href="javascript:void(0);"
                                               class="btn btn-sm btn-danger removeRow"
                                               onclick="removeTableRow('serviceDetailsTable','serviceDetailsTableRow{{$inc}}');">
                                                <i class="fa fa-times"
                                ...
                                @else
                                    <tr id="serviceDetailsTableRow" data-number="1">
                                        <td>
                                            {!! Form::text('service_heading[]', '', ['class' => 'form-control input-md bnEng required', 'placeholder' => trans('messages.available_sevices.heading')]) !!}
                                        </td>
                                        <td>
                                            {!! Form::textarea('service_details[]', '', ['class' => 'form-control input-md service_details bnEng required']) !!}
                                        </td>
                                        <td>
                                            <a class="btn btn-sm btn-primary addTableRows" title="Add more"
                    ...
                    <div class="form-group col-md-12 row {{$errors->has('tutorial_link') ? 'has-error' : ''}}">
                        ...
                        <div class="col-md-10">
                            {!! Form::url('tutorial_link', isset($app->tutorial_link) ? $app->tutorial_link : '' , ['class' => 'form-control']) !!}
                        ...
                        <div class="col-md-10">
                            <table id="documentTable"
                                ...
                                @if($details->isNotEmpty())
                                    <?php $inc = 0; ?>
                                    @foreach($docs as $doc)
                                <tr id="documentTableRow{{$inc}}" data-number="1">
                                    <td>
                                        {!! Form::hidden("document_id[$inc]", $doc->id) !!}
                                        {!! Form::text("document_name[$inc]", $doc->doc_name, ['class' => 'form-control input-md bnEng required', 'placeholder' => trans('messages.available_sevices.document_name')]) !!}
                                    </td>
                                    <td>
                                        <input type="file" class="form-control {{ !empty($doc->file_path)? '':'required' }}" name="document_file[{{$inc}}]" >
                                        <span><a href="{{'/'.$doc->file_path}}" target="_blank">{{$doc->doc_name}}</a></span>
                                    </td>
                                    <td>
                                        <?php if ($inc == 0) { ?>
                                        <a class="btn btn-sm btn-primary addTableRows" title="Add more"
                                           onclick="addTableRow('documentTable', 'documentTableRow0');"><i
                                                    class="fa fa-plus"></i></a>
                                        <?php } else { ?>
                                        <a href="javascript:void(0);"
                                           class="btn btn-sm btn-danger removeRow"
                                           onclick="removeTableRow('documentTable','documentTableRow{{$inc}}');">
                                            <i class="fa fa-times"
                                               aria-hidden="true"></i></a>
                                        <?php } ?>
                                    </td>
                                ...
                                @else
                                    <tr id="documentTableRow" data-number="1">
                                        <td>
                                            {!! Form::text('document_name[0]', '', ['class' => 'form-control input-md required', 'placeholder' => trans('messages.available_sevices.document_name')]) !!}
                                        </td>
                                        <td>
