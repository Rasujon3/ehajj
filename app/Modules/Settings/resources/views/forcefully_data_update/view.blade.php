    ...
    <div class="col-lg-12">
        <div class="card card-primary">
            <div class="card-header">
                <h5><strong>  Forcefully Data Update View</strong></h5>
            </div>
                    ...
                    <div class="col-md-12 padding">
                        <div class="row">
                            ...
                            @elseif($forcefully_data_update->update_type == 'company')
                                ...
                                <div class="col-md-9 col-xs-6">
                                    {{ (!empty($forcefully_data_update->org_nm)) ? $forcefully_data_update->org_nm : '' }}
                                </div>
                            @endif
                        </div>
                    </div>
...
@section('footer-script')
    <script src="<?php echo e(asset("assets/scripts/sweetalert2.all.min.js")); ?>" type="text/javascript"></script>
