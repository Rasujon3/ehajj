{!! Form::open(array('url' => url('/spg/stakeholder-distribution-update/'.Encryption::encodeId($stakeholderDistribution->id)),'method' => 'post', 'class' => 'form-horizontal smart-form','id'=>'stakeholderDistribution',
...
<div class="modal-body">
    ...
    <input name="pay_config_id" type="hidden"
           value="{{ Encryption::encodeId($stakeholderDistribution->sp_pay_config_id) }}">
    <div class="row">
        <div class="col-lg-12">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="form-group row {{$errors->has('amount') ? 'has-error' : ''}}">
                {!! Form::label('pay_amount','Purpose: ',['class'=>'col-md-4 text-right  required-star']) !!}
                <div class="col-md-8">
        ...
        <div class="col-md-12">
            <div class="form-group row {{$errors->has('status') ? 'has-error' : ''}}">
                ...
                <div class="col-md-8 {{$errors->has('fix_status') ? 'has-error' : ''}}">
                    <label>{!! Form::radio('fix_status', 1, ($stakeholderDistribution->fix_status == 1), ['class'=>'required', 'id'=>'fixed']) !!}
                        Fixed</label>
                    <label>{!! Form::radio('fix_status', 0, ($stakeholderDistribution->fix_status == 0), ['class'=>' required', 'id'=>'un_fixed']) !!}
                        Unfixed</label>
    ...
    <div class="row" id="payAmountField">
        <div class="col-lg-12">
            <div class="form-group row {{$errors->has('amount') ? 'has-error' : ''}}">
        ...
        <div class="col-md-12">
            <div class="form-group row {{$errors->has('status') ? 'has-error' : ''}}">
                ...
                <div class="col-md-8 {{$errors->has('status') ? 'has-error' : ''}}">
                    <label>{!! Form::radio('status', 1, ($stakeholderDistribution->status == 1), ['class'=>'required']) !!}
                        Active</label>
                    <label>{!! Form::radio('status', 0, ($stakeholderDistribution->status == 0), ['class'=>' required']) !!}
                        Inactive</label>
...
{{--                {!! Form::label('distribution_type','Distribution type: ',['class'=>'col-md-4 text-right required-star']) !!}--}}
{{--                <div class="col-md-8">--}}
{{--                    {!! Form::select('distribution_type', $distribution_types, $stakeholderDistribution->distribution_type, ['class'=>'form-control input-sm', 'placeholder'=>'Select distribution type']) !!}--}}
{{--                    {!! $errors->first('distribution_type','<span class="help-block">:message</span>') !!}--}}
{{--                </div>--}}
{{--            </div>--}}
{{--        </div>--}}
...
<div class="modal-footer" style="text-align:left; display: block;">
...
<script>
    ...
    document.querySelector('input[name="fix_status"]:checked').click();
</script>
