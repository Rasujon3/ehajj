            ...
            <div class="card card-magenta border border-magenta">
                <div class="card-header">
                    ...
                    <div class="float-left">
                        <h5><strong><i class="fa fa-list"></i>
                                <strong>{!!trans('SonaliPayment::messages.payment_list')!!}</strong></strong></h5>
                    </div>
                    <div class="float-right">
                        {{--<a class="" href="{{ url('/spg/initiate/') }}">--}}
                        {{--{!! Form::button('<i class="fa fa-plus"></i><b> ' .trans('SonaliPayment::messages.new_payment').'</b>', array('type' => 'button', 'class' => 'btn btn-default')) !!}--}}
                        {{--</a>--}}
                        <a class="" href="{{ url('/spg/daily-tansaction') }}">
                            {!! Form::button('<i class="fa fa-list"></i><b> ' .trans('SonaliPayment::messages.daily_transaction').'</b>', array('type' => 'button', 'class' => 'btn btn-default')) !!}
                        </a>
                    </div>
