    ...
    <div class="panel panel-success">
        ...
        <div class="panel-body">
            <div style="margin:0;" class="panel panel-info">
                <div class="panel-heading">
                    {{ !empty($appInfo->payment_category) ? $appInfo->payment_category : 'N/A' }}
                </div>
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="col-md-7">
                                    {{ number_format($appInfo->sfp_pay_amount + $appInfo->sfp_vat_tax + $appInfo->sfp_bank_charge, 2) }}
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="panel-body">
                <div style="margin:0;" class="panel panel-info">
                    ...
                    <div class="panel-footer">
                        ...
                        {{-- Counter payment, 3 = Waiting for Payment Confirmation--}}
                        @if($appInfo->gfp_payment_status == 3)
                            <div class="pull-right">
