            ...
            <div class="box-body">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-info">
                        ...
                        {!! Form::open(array('url' => url('visa-recommendation/store'),'method' => 'post','id' => 'VisaRecommendationForm','enctype'=>'multipart/form-data',
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6 {{$errors->has('sfp_contact_name') ? 'has-error': ''}}">
                                        ...
                                        <div class="col-md-7">
                                            {!! Form::text('sfp_contact_name', getUserFullName(), ['class' => 'form-control input-md required']) !!}
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 {{$errors->has('sfp_contact_address') ? 'has-error': ''}}">
                                        ...
                                        <div class="col-md-7">
                                            {!! Form::text('sfp_contact_address', Auth::user()->contact_address, ['class' => 'form-control input-md required']) !!}
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 {{$errors->has('sfp_vat_tax') ? 'has-error': ''}}">
                                        ...
                                        <div class="col-md-7">
                                            {!! Form::text('sfp_vat_tax', ($payment_config->vat_tax_percent / 100) * $payment_config->amount, ['class' => 'form-control input-md', 'readonly']) !!}
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 {{$errors->has('sfp_bank_charge') ? 'has-error': ''}}">
                                        ...
                                        <div class="col-md-7">
                                            {!! Form::text('sfp_bank_charge', $charge_amount, ['class' => 'form-control input-md', 'readonly']) !!}
                            ...
                            {{--<td>{{ Auth::user()->road_no .  (!empty(Auth::user()->house_no) ? ', ' . Auth::user()->house_no : '') }}</td>--}}
                            {{--</tr>--}}
                            {{--<tr>--}}
                            {{--<td>Payment Name</td>--}}
