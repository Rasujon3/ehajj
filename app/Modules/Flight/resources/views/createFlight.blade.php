    ...
    <div class="dash-content-main">
        <div class="border-card-block">
            ...
            <div class="bd-card-content">
                {!! Form::open(array('url' => 'flight/store-flight','method' => 'post', 'class' => 'form-horizontal', 'id' => 'flightForm',
                    ...
                    <div class="row">
                            ...
                            <div class="card-form-group">
                                <div class="card-form-block {{$errors->has('airlines') ? 'has-error' : ''}}">
                                    {!! Form::label('airlines','Airlines: ',['class'=>'required-star']) !!}
                                        {!! Form::select('airlines', $airlines, $userSubType, ['class'=>'form-control required', 'data-rule-maxlength'=>'40']) !!}
                                ...
                                <div class="card-form-block {{$errors->has('flight_code') ? 'has-error' : ''}}">
                                    {!! Form::label('flight_code','Flight Code: ',['class'=>'required-star']) !!}
                                        {!! Form::text('flight_code',null,['class'=>'form-control required','placeholder'=>'Flight Code',
                                ...
                                <div class="card-form-block {{$errors->has('flight_capacity') ? 'has-error' : ''}}">
                                    {!! Form::label('flight_capacity','Flight Capacity: ',['class'=>'required-star']) !!}
                                        {!! Form::text('flight_capacity',null,['class'=>'form-control number required input-sm','placeholder'=>'Flight Capacity',
                                ...
                                <div class="card-form-block input-has-icon {{$errors->has('departure_time') ? 'has-error' : ''}}">
                                    ...
                                    <div class="">
                                        {!! Form::text('departure_time',null,['class'=>'form-control bnEng required datetimepicker',
                                            'placeholder'=>'MM/DD/YYYY HH:MM', 'data-rule-maxlength'=>'20', 'value'=>"12:00 AM"]) !!}
                                ...
                                <div class="card-form-block {{$errors->has('departure_city') ? 'has-error' : ''}}">
                                    {!! Form::label('departure_city','Departure City: ',['class'=>'required-star']) !!}
                                        {!! Form::select('departure_city', [], null, ['class'=>'form-control required',
                                        'data-rule-maxlength'=>'20', 'id'=> 'departure_city']) !!}
                                ...
                                <div class="card-form-block input-has-icon {{$errors->has('pnl_time') ? 'has-error' : ''}}" id="pnl_div">
                                    ...
                                    {!! Form::text('pnl_time',null,['class'=>'form-control bnEng datetimepicker',
                                ...
                                <div class="card-form-block {{$errors->has('route_to_makkah') ? 'has-error' : ''}}" id="r2m">
                                    ...
                                    <span style="margin-right: 10px;">
                                        {!! Form::radio('route_to_makkah', 'yes', false, ['class' => 'required', 'id' => 'makkah_yes']) !!} Yes
                                    </span>
                                    <span>
                                        {!! Form::radio('route_to_makkah', 'no', false, ['class' => 'required', 'id' => 'makkah_no']) !!} No
                                    </span>
                            ...
                            <div class="card-form-group">
                                <div class="card-form-block {{$errors->has('aircraft') ? 'has-error' : ''}}">
                                    {!! Form::label('aircraft','Aircraft: ',['class'=>'required-star']) !!}
                                        {!! Form::select('aircraft', $aircrafts, null, ['class'=>'form-control required', 'data-rule-maxlength'=>'20']) !!}
                                ...
                                <div class="card-form-block {{$errors->has('type') ? 'has-error' : ''}}">
                                    ...
                                    {!! Form::select('type', $flight_type, null, ['class'=>'form-control required',
                                ...
                                <div class="card-form-block input-has-icon {{$errors->has('flight_duration') ? 'has-error' : ''}}">
                                    ...
                                    {!! Form::text('flight_duration', old('flight_duration'),['class'=>'form-control required input-sm', 'data-rule-maxlength'=>'40',
                                ...
                                <div class="card-form-block input-has-icon {{$errors->has('arrival_time') ? 'has-error' : ''}}">
                                    ...
                                    <div class="">
                                        {!! Form::text('arrival_time',null,['class'=>'form-control bnEng required datetimepicker',
                                        'placeholder'=>'MM/DD/YYYY HH:MM', 'data-rule-maxlength'=>'20']) !!}
                                        <span class="form-input-icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19" fill="none">
                                                <g clip-path="url(#clip0_2139_2701)">
                                ...
                                <div class="card-form-block {{$errors->has('arrival_city') ? 'has-error' : ''}}">
                                    ...
                                    {!! Form::select('arrival_city', [], null,['class'=>'form-control required',
                                ...
                                <div class="card-form-block {{$errors->has('gaca_reservation_no') ? 'has-error' : ''}}">
                                    ...
                                    {!! Form::text('gaca_reservation_no',null,['class'=>'form-control text','placeholder'=>'Enter GACA No',
                                    'data-rule-maxlength'=>'40']) !!}
                                ...
                                <div class="card-form-block {{$errors->has('pilgrim_type') ? 'has-error' : ''}}">
                                    ...
                                    {!! Form::select('pilgrim_type', $pilgrim_type, null,['class'=>'form-control required',
                        ...
                        <div class="col-lg-12 {{$errors->has('description') ? 'has-error' : ''}}">
                            <div class="form-group">
                                ...
                                {!! Form::textarea('description',null,['class'=>'form-control','placeholder'=>'Enter the remarks (if any)',
            ...
            <div class="bd-card-footer">
                <div class="flex-space-btw info-btn-group">
                    ...
                    <button type="submit" class="btn btn-green"><span>Create</span></button>
                </div>
            </div>
            {!! Form::close() !!}<!-- /.form end -->
        </div>
...
@section('footer-script')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            const bdCitys = `{!! $bd_cities !!}`;
            const ksaCitys = `{!! $ksa_cities !!}`;
            ...
            $('#type').on('change', function() {
                ...
                if(flightType === 'departure') {
                    $('#departure_city').html(bdCitys);
                    $('#arrival_city').html(ksaCitys);
                } else if(flightType === 'arrival') {
                    $('#departure_city').html(ksaCitys);
                    $('#arrival_city').html(bdCitys);
                } else {
                    $('#departure_city').html(`<option value="">Select One</option>`);
                    $('#arrival_city').html(`<option value="">Select One</option>`);
                }
            });
            $('#type').trigger('change');
