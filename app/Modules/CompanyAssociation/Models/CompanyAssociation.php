...
class CompanyAssociation extends Model
{
    ...
    public static function companyAssociationList()
    {
        ...
        return CompanyAssociation::leftJoin('company_info', 'company_info.id', '=', 'company_association_request.requested_company_id')
            ...
            ->orderBy('company_association_request.id', 'DESC')
