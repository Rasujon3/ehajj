                    ...
                    <div class="row">
                        <div class="col-md-10 col-md-offset-1">
                            ...
                            @if(!empty(Auth::user()->working_company_id))
                                <button type="button" class="skip-button" id="steps_modal" data-dismiss="modal"
                                        value="skip">Continue with
                                    ({{ CommonFunction::getCompanyNameById(Auth::user()->working_company_id) }}) company
                                </button>
                            @endif
                            <h5><span>or</span></h5>

                            <div class="control-group">
                                <select name="requested_company_id" class="form-control required limitedNumbSelect2"
                                        data-placeholder="Select working company" style="width: 80%;">
