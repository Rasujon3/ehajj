                    ...
                    <div class="row">
                            ...
                            <div class="card-form-group">
                                <div class="card-form-block {{$errors->has('bulletinType') ? 'has-error' : ''}}">
                                    {!! Form::label('bulletinType','ধরন: ',['class'=>'required-star']) !!}
                                        {!! Form::select('bulletinType', ['PRE_HAJ' => 'Pre-Haj','POST_HAJ' =>'Post-Haj'], $singleBulletinInfo->haj_type, ['class'=>'form-control required', 'id' => 'bulletinType', 'data-rule-maxlength'=>'40']) !!}
                                        {!! $errors->first('bulletinType','<span class="help-block">:message</span>') !!}
                                </div>
                                <div class="card-form-block hidden {{$errors->has('bulletinId') ? 'has-error' : ''}}">
                                    {!! Form::label('bulletinId','',['class'=>'required-star hidden']) !!}
                                        {!! Form::hidden('bulletinId',Encryption::encodeId($singleBulletinInfo->id),['class'=>'form-control', 'id' => 'bulletinId' ]) !!}
                                         {!! Form::hidden('bulletinNewsId',$bulletinNewsData ? Encryption::encodeId($bulletinNewsData->id) : null,['class'=>'form-control', 'id' => 'bulletinNewsId']) !!}
                                        {!! $errors->first('bulletinId','<span class="help-block">:message</span>') !!}
                                </div>
                                <div class="card-form-block {{$errors->has('numberOfPublication') ? 'has-error' : ''}}">
                                    {!! Form::label('numberOfPublication','প্রকাশের সংখ্যা: ',['class'=>'required-star']) !!}
                                        {!! Form::text('numberOfPublication',$singleBulletinInfo->bulletin_number,['class'=>'form-control required', 'id' => 'numberOfPublication',  'placeholder'=>'প্রকাশের সংখ্যা',
                                        'data-rule-maxlength'=>'40']) !!}
                                        {!! $errors->first('numberOfPublication','<span class="help-block">:message</span>') !!}
                                </div>
                                <div class="card-form-block {{$errors->has('publicationDateAndTime') ? 'has-error' : ''}}">
                                    {!! Form::label('publicationDateAndTime','প্রকাশের তারিখ এবং সময়: ',['class'=>'required-star']) !!}
                                        {!! Form::text('publicationDateAndTime',$singleBulletinInfo->publish_date_time,['class'=>'form-control required', 'id' => 'publicationDateAndTime',  'placeholder'=>'প্রকাশের তারিখ এবং সময়',
                                        ]) !!}
                                        {!! $errors->first('publicationDateAndTime','<span class="help-block">:message</span>') !!}
                                </div>
                                <div class="card-form-block {{$errors->has('totalGovHajjPassenger') ? 'has-error' : ''}}">
                                    {!! Form::label('totalGovHajjPassenger','সরকারি হজযাত্রী সংখ্যা: ',['class'=>'required-star']) !!}
                                        {!! Form::text('totalGovHajjPassenger',$singleBulletinInfo->govt_pilgrim,['class'=>'form-control required', 'id' => 'totalGovHajjPassenger', 'placeholder'=>'সরকারি হজযাত্রী সংখ্যা',
                                        'data-rule-maxlength'=>'40']) !!}
                                ...
                                <div class="card-form-block {{$errors->has('totalFlightCount') ? 'has-error' : ''}}">
                                    {!! Form::label('totalFlightCount','মোট ফ্লাইট সংখ্যা: ',['class'=>'required-star']) !!}
                                        {!! Form::text('totalFlightCount',$singleBulletinInfo->total_flight,['class'=>'form-control required', 'id' => 'totalFlightCount',  'placeholder'=>'মোট ফ্লাইট সংখ্যা',
                                        'data-rule-maxlength'=>'40']) !!}
                                ...
                                <div class="card-form-block {{$errors->has('soudiaFlightCount') ? 'has-error' : ''}}">
                                    {!! Form::label('soudiaFlightCount','সৌদিয়া ফ্লাইট সংখ্যা : ',['class'=>'required-star']) !!}
                                        {!! Form::text('soudiaFlightCount',$singleBulletinInfo->sv_flight,['class'=>'form-control required', 'id' => 'soudiaFlightCount',  'placeholder'=>'সৌদিয়া ফ্লাইট সংখ্যা',
                                        'data-rule-maxlength'=>'40']) !!}
                                ...
                                <div class="card-form-block {{$errors->has('medicalPaperCount') ? 'has-error' : ''}}">
                                    {!! Form::label('medicalPaperCount','চিকিৎসা পত্র সংখ্যা: ',['class'=>'required-star']) !!}
                                        {!! Form::text('medicalPaperCount',$singleBulletinInfo->medical_service,['class'=>'form-control required', 'id' => 'medicalPaperCount', 'placeholder'=>'চিকিৎসা পত্র সংখ্যা',
                                        'data-rule-maxlength'=>'40']) !!}
                                ...
                                <div class="card-form-block {{$errors->has('itHelpDesk') ? 'has-error' : ''}}">
                                    ...
                                    {!! Form::text('itHelpDesk',$singleBulletinInfo->it_helpdesk_service,['class'=>'form-control required', 'id' => 'itHelpDesk',  'placeholder'=>'আইটি হেল্প ডেস্ক সেবা',
                                    'data-rule-maxlength'=>'40']) !!}
                        ...
                        <div class="col-lg-6">
                            <div class="card-form-group">
                                <div class="card-form-block input-has-icon {{$errors->has('bulletinDateEng') ? 'has-error' : ''}}">
                                    ...
                                    <div class="">
                                        {!! Form::text('bulletinDateEng',$singleBulletinInfo->bulletin_date,['class'=>'form-control bnEng required datetimepicker',
                                ...
                                <div class="card-form-block {{$errors->has('bulletinDate') ? 'has-error' : ''}}">
                                    {!! Form::label('bulletinDate','বুলেটিন তারিখ বাংলায়: ',['class'=>'required-star']) !!}
                                        {!! Form::text('bulletinDate',$singleBulletinInfo->bulletin_date_bn,['class'=>'form-control required', 'id' => 'bulletinDate',  'placeholder'=>'বুলেটিন তারিখ বাংলায়',
                                        ]) !!}
                                ...
                                <div class="card-form-block {{$errors->has('totalHajjPassenger') ? 'has-error' : ''}}">
                                    {!! Form::label('totalHajjPassenger','সর্বমোট হজযাত্রী সংখ্যা: ',['class'=>'required-star']) !!}
                                        {!! Form::text('totalHajjPassenger',$singleBulletinInfo->total_pilgrim,['class'=>'form-control required', 'id' => 'totalHajjPassenger', 'placeholder'=>'সর্বমোট হজযাত্রী সংখ্যা',
                                        'data-rule-maxlength'=>'40']) !!}
                                        {!! $errors->first('totalHajjPassenger','<span class="help-block">:message</span>') !!}
                                </div>
                                <div class="card-form-block {{$errors->has('nonGovHajjPassengerCount') ? 'has-error' : ''}}">
                                    {!! Form::label('nonGovHajjPassengerCount','বেসরকারি হজযাত্রী সংখ্যা: ',['class'=>'required-star']) !!}
                                        {!! Form::text('nonGovHajjPassengerCount',$singleBulletinInfo->pvt_pilgrim,['class'=>'form-control required', 'id' => 'nonGovHajjPassengerCount',  'placeholder'=>'বেসরকারি হজযাত্রী সংখ্যা',
                                        'data-rule-maxlength'=>'40']) !!}
                                ...
                                <div
                                    ...
                                    {!! Form::text('bimanPassengerCount',$singleBulletinInfo->bg_pilgrims ?: "",['class'=>'form-control required', 'id' => 'bimanPassengerCount',  'placeholder'=>'বিমান হজযাত্রী সংখ্যা',
                                    'data-rule-maxlength'=>'40']) !!}
                                ...
                                <div
                                    ...
                                    {!! Form::text('soudiaPassengerCount',$singleBulletinInfo->soudia_pilgrims ?: "",['class'=>'form-control required', 'id' => 'soudiaPassengerCount',  'placeholder'=>'সৌদিয়া হজযাত্রী সংখ্যা',
                                    'data-rule-maxlength'=>'40']) !!}
                                ...
                                <div
                                    ...
                                    {!! Form::text('flynasPassengerCount',$singleBulletinInfo->flynas_pilgrims ?: "",['class'=>'form-control required', 'id' => 'flynasPassengerCount',  'placeholder'=>'ফ্লাইনাস হজযাত্রী সংখ্যা',
                                    'data-rule-maxlength'=>'40']) !!}
                                    {!! $errors->first('flynasPassengerCount','<span class="help-block">:message</span>') !!}
                                </div>
                                <div class="card-form-block {{$errors->has('bimanFlightNumberCount') ? 'has-error' : ''}}">
                                    {!! Form::label('bimanFlightNumberCount','বিমান ফ্লাইট সংখ্যা: ',['class'=>'required-star']) !!}
                                        {!! Form::text('bimanFlightNumberCount',$singleBulletinInfo->bg_flight,['class'=>'form-control required', 'id' => 'bimanFlightNumberCount', 'placeholder'=>'বিমান ফ্লাইট সংখ্যা',
                                        'data-rule-maxlength'=>'40']) !!}
                                        {!! $errors->first('bimanFlightNumberCount','<span class="help-block">:message</span>') !!}
                                </div>
                                <div class="card-form-block {{$errors->has('flynasFlightNumberCount') ? 'has-error' : ''}}">
                                    {!! Form::label('flynasFlightNumberCount','ফ্লাইনাস ফ্লাইট সংখ্যা: ',['class'=>'required-star']) !!}
                                        {!! Form::text('flynasFlightNumberCount',$singleBulletinInfo->xy_flight,['class'=>'form-control required', 'id' => 'flynasFlightNumberCount', 'placeholder'=>'ফ্লাইনাস ফ্লাইট সংখ্যা',
                                        'data-rule-maxlength'=>'40']) !!}
                        ...
                        <div class="card-form-group">
                            ...
                            <textarea class="form-control" id="additional_txt" name="additional_txt" cols="40"
                                rows="10">{{$singleBulletinInfo->main_massage_text}}</textarea>
                        </div>

                        <div class="card-form-group">
                            <label for="activities">একনজরে হজ এর কার্যক্রম</label>
                            <textarea class="form-control" id="activities" name="activities" cols="40"
                                rows="10">{{$singleBulletinInfo->fixed_text}}</textarea>
                        </div>
                    </div>
                </div>
            </div>
