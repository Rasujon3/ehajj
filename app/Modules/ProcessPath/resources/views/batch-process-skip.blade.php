    ...
    <div class="col-md-12">
        ...
        <div class="col-md-2 pull-right">
            <div class="form-group">
                <a class="btn btn-primary btn-block" @if($total_process_app == $total_selected_app) disabled=""
                   @else  href="/process/batch-process-skip/{{$single_process_id_encrypt}}" @endif > Next <i
                            class="fa fa-angle-double-right"></i></a>
            </div>
        </div>
        <div class="col-md-2 pull-right">
            <div class="form-group">
                <a class="btn btn-info btn-block" @if($total_process_app == 1) disabled=""
