...
@section('content')
    <div class="form-group">
        <div class="row">
                <label for="" class="col-md-2">Select inventory:</label>
                <div class="col-md-4">
                    {!! Form::select('inventory_type', $inventoryType, null, ['class'=>'form-control', 'placeholder'=>'Total Inventory', 'id'=>'inventory_type', 'onchange'=>'loadTable(this.value)']) !!}
                </div>
        </div>
    </div>
    ...
    <div class="form-group">
        <div class="row">
            <div id="total_inventory" class="col-md-12">
...
@section('footer-script')
    ...
    <script>
        ...
        function loadTable(pharmacyId){
            loadAjaxTable(pharmacyId)
        }

        function loadAjaxTable(pharmacyId=''){
            $.ajax({
                type: "get",
