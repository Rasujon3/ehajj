...
<div class="dash-content-main">
    <div class="dash-sec-head mt-3">
        <h3>সরকারি হজযাত্রী লিষ্টিং ( {{$session_id['caption']}} )</h3>
    </div>
                     ...
                     @if (in_array($user_type, explode(',', $process_info['active_menu_for'])) )
                        <div class="row">
                            ...
                            <div class="col-sm-6 text-right">
                                <div class="toggle_data_talbe">
                                    <button class="btn btn-danger btn-sm" id="beforPosition"> পূর্বাবস্থায় </button>
                                    <button class="btn btn-primary btn-sm" name="actionBtn" value="draft" id="draft" >সংরক্ষণ এবং খসড়া</button>
                                    <button class="btn btn-success btn-sm" name="actionBtn" value="submit" id="save" >সাবমিট</button>
                                </div>
                            </div>
                        </div>
                    @endif
                ...
                success: function(response) {
                    ...
                    $('.load_pilgrim').html("<tr class='mt-3'><td class='pt-4 text-red' colspan='6'>Data not found!!</td></tr>");
                        ...
                        for(var i = 0 ; i<dataLen; i++){
                            if(response.data.data[i]['pilgrim_listing_id']!=0 && is_proceed==1){
