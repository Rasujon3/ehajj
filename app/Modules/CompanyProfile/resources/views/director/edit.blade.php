...
{{--                        {!! Form::select('nid_designation', $designation, $director_list['l_director_designation'], ['class' => 'form-control input-md required']) !!}--}}
...
{{--                        {!! Form::select('tin_designation', $designation, $director_list['l_director_designation'], ['class' => 'form-control input-md required']) !!}--}}
...
{{--                    {!! Form::select('passport_designation', $designation, $director_list['l_director_designation'], ['class' => 'form-control input-md required']) !!}--}}
