                ...
                <div class="card-body" style="padding: 0 15px">
                    ...
                    <fieldset>
                        <div id="section_one">
                            ...
                            {!! Form::hidden('steps', 'step_one' ,['class' => 'form-control input-md required save_data','id'=>'steps']) !!}
                            {{--Re-reg Info--}}
                            <div class="card card-magenta border border-magenta Information required for re-registration">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-7 {{$errors->has('company_name_bangla') ? 'has-error': ''}}">
                                                   ...
                                                   'class' => 'form-control input-md','id'=>'company_name_bangla', 'readonly'=> $companyUserType != 'Employee' ? true : false]) !!}
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                {!! Form::label('service_name_manual', trans('IndustryReRegistration::messages.manual_service_name'),
                                                                                                ['class'=>'col-md-5 ']) !!}
                                                <div class="col-md-7 {{$errors->has('service_name_manual') ? 'has-error': ''}}">
                                                    {!! Form::text('service_name_manual',$appInfo->service_name, ['placeholder' => trans("IndustryReRegistration::messages.write_manual_service_name"),
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-7 {{$errors->has('manual_reg_number') ? 'has-error': ''}}">
                                                    {!! Form::text('manual_reg_number', $appInfo->manual_reg_number, ['placeholder' => trans("IndustryReRegistration::messages.write_manual_reg_number"),
                                            ...
                                            <div class="form-group row {{$errors->has('manual_reg_date') ? 'has-error': ''}}">
                                                ...
                                                <div class=" col-md-7">
                                                    <div class="input-group date datetimepicker4" id="manual_reg_date" data-target-input="nearest">
                                                        {!! Form::text('manual_reg_date', date('d-m-Y', strtotime($appInfo->manual_reg_date)) , ['class'=>'form-control input_ban', 'id'=>'manual_reg_date']) !!}
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-7 {{$errors->has('total_investment') ? 'has-error': ''}}">
                                                    {!! Form::text('total_investment',  $appInfo->total_investment, ['placeholder' => trans("CompanyProfile::messages.write_total_investment"),
                            ...
                            <div class="card card-magenta border border-magenta">
                                ...
                                <div class="card-body" style="padding: 15px 25px;">
                                        ...
                                        <div class="col-md-12 text-right">
                                            <a style="margin-left: 23px" data-toggle="modal"
                                               ...
                                               data-action="{{ url('client/company-profile/create-info') }}">
                                                <button style="margin-right: 15px; margin-top: 5px" type="button"
                                            ...
                                            <div class="form-group row {{$errors->has('company_ceo_dob') ? 'has-error': ''}}">
                                                ...
                                                <div class=" col-md-7">
                                                    <div class="input-group date datetimepicker4" id="company_ceo_dob" data-target-input="nearest">
                                                        {!! Form::text('company_ceo_dob', date('d-m-Y', strtotime($appInfo->dob)), ['class'=>'form-control input_ban', 'id'=>'company_ceo_dob', 'readonly'=>true]) !!}
                                    ...
                                    <div class="col-md-7 col-centered">
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="signature-upload" style="min-height: 150px;">
                                                    <div class="col-md-12">
                                                        ...
                                                        <input type="file"
                                                               class="form-control  signature-upload-input input-sm   {{ !empty($appInfo->entrepreneur_signature)? '':'required' }}"
                                    ...
                                    <div class="card card-magenta border border-magenta">
                                        ...
                                        <div class="table_responsive">
                                            <table id="loanSourceTable" class="table table-bordered">
                                                ...
                                                <tbody>
                                                @if ($loanSources->isNotEmpty())
                                                    <?php $inc = 0; ?>
                                                    @foreach ($loanSources as $loanSource)
                    ...
                    <fieldset>
                        <div id="section_two">
                            {!! Form::hidden('app_id', Encryption::encodeId($appInfo->id) ,['class' => 'form-control input-md required', 'id'=>'app_id']) !!}
                            {!! Form::hidden('steps', 'step_two' ,['class' => 'form-control input-md required save_data','id'=>'steps']) !!}
                                ...
                                <div class="card-body table-responsive" style="padding: 15px 25px;">
                                    ...
                                    <div class="card card-magenta border border-magenta">
                                        ...
                                        <div class="card-body table-responsive" style="padding: 15px 25px;">
                                            ...
                                            {!! CommonComponent()->addRow($elementArray, $tableInfo, $localMaterial) !!}
                                            <table class="table">
                                                <tr>

                                                    <td class="text-right"
                                                        width="70%">{!!trans('CompanyProfile::messages.grand_total')!!}</td>

                                                    <td rowspan="1">
                                                        {!! Form::text('local_raw_price_total', (isset($appInfo->local_raw_price_total) ? $appInfo->local_raw_price_total : ''), ['class' => 'form-control input-md text-center onlyNumber input_ban tabInput', 'readonly', 'placeholder'=> trans('CompanyProfile::messages.price_taka'), 'id'=> 'local_raw_price_total']) !!}
                                    ...
                                    <div class="card card-magenta border border-magenta">
                                        ...
                                        <div class="card-body table-responsive" style="padding: 15px 25px;">
                                            ...
                                            {!! CommonComponent()->addRow($elementArray, $tableInfo, $importedMaterial) !!}
                                            <table class="table">
                                                <tr>
                                                    ...
                                                    <td rowspan="1">
                                                        {!! Form::text('imported_raw_price_total', (isset($appInfo->imported_raw_price_total) ? $appInfo->imported_raw_price_total : ''), ['class' => 'form-control input-md text-center onlyNumber input_ban tabInput', 'readonly', 'placeholder'=> trans('CompanyProfile::messages.price_taka'), 'id'=> 'imported_raw_price_total']) !!}
                            ...
                            <div class="card card-magenta border border-magenta">
                                ...
                                <div class="card-body" style="padding: 15px 25px;">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                {!! Form::label('auth_person_address', trans('CompanyProfile::messages.address'), ['class'=>'col-md-3']) !!}
                                                <div class="col-md-8 {{$errors->has('auth_person_address') ? 'has-error': ''}}"
                                                   ...
                                                   'class' => 'form-control input-md','id'=>'auth_person_address', 'style'=>'margin-left: -48px;']) !!}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                {!! Form::label('auth_person_email', trans('CompanyProfile::messages.email'), ['class'=>'col-md-5']) !!}
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 {{$errors->has('trade_license') ? 'has-error': ''}}">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-7">
                                                    <input type="file" name="authorization_letter" id="trade_license" class="form-control"
                                                           <?php if (empty($appInfo->authorization_letter)) {
                                                               echo "class='required'";
                                                           } ?>
                                                    ...
                                                    <div id="preview_trade_license">
                                                        <input type="hidden"
                                                               value="{{ !empty($appInfo->authorization_letter) ? $appInfo->authorization_letter : '' }}"
                                                               id="validate_field_trade_license"
                                                               name="validate_field_trade_license" class="required">
                                                    </div>

                                                    @if(!empty($appInfo->authorization_letter))
                                                        <a target="_blank" class="btn btn-xs btn-primary"
                                                           href="{{URL::to('/uploads/'.$appInfo->authorization_letter)}}"
                                                           title="{{ $appInfo->authorization_letter }}">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-9">
                                                            <input type="file" class="form-control input-sm"
                                                                   value="{{$appInfo->entrepreneur_signature}}"
                                                        ...
                                                        <div class="col-md-3">
                                                            <label class="center-block image-upload"
                                                                ...
                                                                <figure>
                                                                    <img src="{{ (!empty($appInfo->entrepreneur_signature)? url('/'.$appInfo->auth_person_pic) : url('assets/images/photo_default.png')) }}"
                                                                         class="img-responsive img-thumbnail"
                            ...
                            <div class="card card-magenta border border-magenta">
                                ...
                                <div class="card-body" style="padding: 15px 25px;">
                                    <p style="color: #452A73;">
                                        ...
                                        মাধ্যমে জমাকৃত আবেদনপত্রে কোন ধরণের অসঙ্গতি পরিলক্ষিত হলে গণপ্রজাতন্ত্রী
                                        বাংলাদেশ
                                    ...
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            আমি এই মর্মে ঘোষণা করছি যে উপরে বর্ণিত যাবতীয় তথ্য সঠিক আছে। কোন তথ্য গোপন
                                            করা
                                            হয় নাই। কোন তথ্য সঠিক পাওয়া না গেলে কর্তৃপক্ষ শিল্প প্রতিষ্ঠানটির নিবন্ধন
                                            বাতিল
                                            করতে পারবেন এবং যে কোন প্রকার প্রশাসনিক ও আইনানুগ ব্যবস্থা গ্রহণ করতে পারবে।
                                            আমি
                                            আরো ঘোষণা করছি যে, কর্তৃপক্ষ কর্তৃক সরেজমিনে পরিদর্শনকালে সকল প্রকার
                                            সহযোগিতা
                    ...
                    <fieldset>
                        <div id="section_four">
                            {!! Form::hidden('app_id', Encryption::encodeId($appInfo->id) ,['class' => 'form-control input-md required', 'id'=>'app_id']) !!}
                            {!! Form::hidden('steps', 'step_four' ,['class' => 'form-control input-md required']) !!}
                        ...
                        @if(!in_array($appInfo->status_id,[5]))
                            <div class="float-left">
                                ...
                                <button type="button" class="btn btn-info btn-md cancel"
                                        value="section_one" name="actionBtn" id="saveData"><i class="fa fa-save"></i>
                                    Save
                                </button>
                            </div>
    ...
    $(document).ready(function () {
        ...
        form.steps({
            ...
            onInit: function (event, currentIndex) {
                ...
                $(".actions a[href='#next']").attr({style: "background:#3273AB", value: "{{$appInfo->status_id == 5 ?'re-submit':'draft'}}" });
            },
        ...
        $("#submitForm").click(function () {// payment and submit button
            var value = 'Submit';
        ...
        $("#saveData").on('click', function () { // for individual section wise data store
            var value = $(this).val();
            var actionBtn = 'draft';
...
<script>
    $(document).ready(function () {
        $('#business_category_id').on('change', function () {
            ...
            var oldBusinessCategoryId = '{{$appInfo->business_category_id}}';

            if (businessCategoryId != oldBusinessCategoryId) {
                $('#company_ceo_designation_id').val('');
            } else {
                $('#company_ceo_designation_id').val('{{(isset($appInfo->designation) ? $appInfo->designation : '')}}');
            }
        })
    })
