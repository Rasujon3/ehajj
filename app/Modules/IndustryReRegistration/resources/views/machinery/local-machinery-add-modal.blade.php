...
<div class="modal-body">
    ...
    <table id="local_machine_manual_input_table"
        ...
        <tr class="text-center">
            <td>
                {!! Form::text('local_machinery_nm', '', ['class' => 'form-control input-md', 'placeholder'=> trans('CompanyProfile::messages.machinery_name'), 'id'=> 'local_machinery_name']) !!}
                {!! $errors->first('local_machinery_nm','<span class="help-block">:message</span>') !!}
            </td>
            <td>
                {!! Form::text('local_machinery_qty', '', ['class' => 'form-control input-md onlyNumber input_ban', 'placeholder'=> trans('CompanyProfile::messages.n_number'), 'id'=> 'local_machinery_number']) !!}
                {!! $errors->first('local_machinery_qty','<span class="help-block">:message</span>') !!}
            </td>
            <td>
                {!! Form::text('local_machinery_price', '', ['class' => 'form-control input-md onlyNumber input_ban', 'placeholder'=> trans('CompanyProfile::messages.price_taka'), 'id'=> 'local_machinery_price']) !!}
...
<script>
    $(document).ready(function () {
        ...
        $('.local_previous_btn').on('click', function () {
            ...
            // $('.local_save_btns').removeClass('attachmentFile');
        ...
        $('#local_machine_file_upload').on('click', function () {
            ...
            // $('.local_save_btns').addClass('attachmentFile');
    ...
    $(document).off('click').on('click', '#attachmentFile', function() {
        ...
        form_data.append('type', "local");
        // console.log(form_data);
        $.ajax({
            url: '/client/industry-re-registration/local-machinery/attachment', // <-- point to server-side PHP script
