...
//        }
    ...
    /**
     * This encode function used for ehajj Api response
     * @param $value
     * @param  $skey
     * @return encode value
     */
    public static function api_encode($value, $skey=""){
    ...
    /**
     * This decode  function used for ehajj Api response
     * @param $value
     * @param  $skey
     * @return decode value
     */
    public static function api_decode($value, $skey=""){
        if(!$value){return false;}
        if(strlen($skey)==0) $skey=Encryption::$defskey;
        if( function_exists( 'mcrypt_module_open' ) ){
            //echo 'ok- mcrypt enabled';
