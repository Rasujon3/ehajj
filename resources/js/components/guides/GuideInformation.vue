...
<template>
    <div class="row pt-2" id="trackingNoDiv">
        <div class="col-lg-6">
            <div class="input-block-item">
                ...
                <input type="text" class="form-control" id="trackingNoField" :class="[allerros.tracking_no ? 'has-error' : '']" v-model="guideData.tracking_no">
            </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            ...
            <span v-if="allerros.birth_place" class="text-danger">{{ allerros.birth_place[0] }}</span>
        </div>
        <div class="col-lg-6">
            <div class="input-block-item">
