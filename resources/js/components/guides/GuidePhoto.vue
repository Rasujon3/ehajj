...
const profilePicUrl = ref('/assets/custom/images/2024/06/user-photo.png');
function onProfilePicFileChange(event) {
    fileInput = event.target;
    const file = event.target.files[0];
    if (file && file.type.startsWith('image/')) {
        // guideData.value.profile_pic = file; // this is guide profile pic
        // profilePicUrl.value = URL.createObjectURL(file); // this is preview image
        ...
        guideData.value.profile_pic = null;
        profilePicUrl.value = '/assets/custom/images/2024/06/user-photo.png';
    }
}
            ...
            <div class="file-upload-box">
                <div class="upload-box-container">
                    ...
                    <div class="fileUpload btn btn-filebrowse">
                        ...
                        <input id="uploadBtn" ref="uploadBtn" type="file" class="uploadInput" :class="[{ required: true }]" @change="onProfilePicFileChange" required>
                    </div>
