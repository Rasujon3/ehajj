                    ...
                    <div class="row form-group ">
                        ...
                        <div class="col-md-10">
                            <label><input v-model="termscondition.status" name="status" type="radio"
                                          :checked="termscondition.status"  value="1" id="status"> Active&nbsp;</label>
                            <label><input v-model="termscondition.status" name="status" type="radio"
                                          :checked="termscondition.status"  value="0" id="status"> Inactive</label>
    ...
    export default {
        ...
        methods: {
            ...
            saveForm() {
                ...
                axios.post('/settings/store-terms-condition', form)
                    .then(function (resp) {
                        if (resp.data.status === true) {
                            app.$toast.success('Your Terms & Condition crate successfully.');
                            app.$router.push({path: '/terms-condition'});
                        }
