<template>
    <div class="panel panel-primary">
            <div class="panel-heading">Industrial Advisor Edit</div>
                ...
                <div class="panel-body">
                    <div class="col-md-11">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-md-2">
                                <a class="btn btn-info" target="_blank" v-bind:href="'/'+ advisor.profile_photo"><i
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            console.log(id);
            app.$id = id;
            axios.get('/settings/home-page/edit-industrial-advisor/' + id)
                .then(function (resp) {
        ...
        methods: {
            ...
            saveForm() {
                ...
                axios.post('/settings/home-page/update-industrial-advisor' ,form)
                    .then(function (resp) {
                        if (resp.data.status === true) {
                            app.$toaster.success('Your data update successfully.');
                            app.$router.replace('/home-page/industrial-advisor');
                        }
                    }).catch((error) => {
