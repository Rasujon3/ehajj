...
<div class="box box-success">
    <div class="box-header with-border">
        <h5 class="box-title"><strong><i class="fa fa-list"></i> <strong>Regulatory Agency</strong></strong></h5>
        <div class="pull-right box-tools">
            <router-link :to="{name: 'RegulatoryAgencyCreate'}" class="btn btn-success"><i class="fa fa-plus"></i> Add New Regulatory Agency</router-link>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="table-responsive">
                    ...
                    <tbody>
                    <tr v-for="agency in laravelData.data" :key="agency.id">
                        <td>{{agency.si}}</td>
                        <td>{{agency.name}}</td>
                        ...
                        <td>
                        <span v-if="agency.status == 1" class="label label-success">Active</span>
                        <span v-else class="label label-success">Inactive</span>
                        </td>
                        <td>
                            <router-link :to="{name: 'RegulatoryAgencyEdit', params: {id: agency.id}}" class="btn btn-xs btn-primary">
    ...
    export default {
        ...
        methods: {
            getResults(page) {
                ...
                this.$http.get('/settings/home-page/regulatory-agency?page=' + page + is_search + max_limit)
                    .then(response => {
